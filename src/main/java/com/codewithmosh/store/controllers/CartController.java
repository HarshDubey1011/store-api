...
public class CartController {
    ...
    public ResponseEntity<?> updateItem(@PathVariable("cartId") UUID cartId, @PathVariable("productId") Long productId, @Valid @RequestBody UpdateCartItemRequest updateCartItemRequest) {
        var cart =  cartRepository.findById(cartId).orElse(null);
        if(cart == null) {
